...
namespace BookStore
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //specify the same object should be always used
            // tells MVC to use the HttpContextAcessor class when implementations
            // of the IHttpContextAccessor interface are reqiured
            //this service reqiuredso i can access the current session in the SessionCart class
            //
